...
public class Conversion_Test {
    ...
    @Test
    public void WHEN_15_BGN_to_USD_RETURNS_26_25() throws Exception {
        mockMvc.perform(
                MockMvcRequestBuilders.get("/api/1.0/conversion/get/15/BGN/USD"))
                .andDo(MockMvcResultHandlers.print())
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().string(containsString(Double.toString(15.0 * 1.75))));
    }

    @Test
    public void WHEN_15_25_BGN_to_USD_RETURNS_26_6875() throws Exception {
        mockMvc.perform(
                MockMvcRequestBuilders.get("/api/1.0/conversion/get/15.25/BGN/USD"))
                .andDo(MockMvcResultHandlers.print())
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().string(containsString(Double.toString(15.25 * 1.75))));
    }
